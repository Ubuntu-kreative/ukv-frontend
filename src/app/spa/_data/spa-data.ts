...
export const RITUALS: Ritual[] = [
  ...
  },
  {
    ...
    image: '/images/Smoked-Bath1.jpeg',
  ...
  },
  {
    ...
    image: '/images/Deep-Tissue-Massage.jpeg',
  ...
  },
  {
    ...
    image: '/images/Stress-Relief-Mental-Wellness.jpeg',
  ...
  },
  {
    ...
    image: '/images/Full-Day-Arohamai-Wellness-Escape.jpeg',
...
export const SPA_SERVICES: SpaService[] = [
  { title: 'Bath & Heat Therapies', subtitle: 'From KES 2,000', tag: 'Detox & Restore', ritualId: 'moroccan-bath', accent: 'rgba(160,80,160,0.16)', image: '/images/Moroccan-Bath.jpeg', description: 'Mud bath, salt bath, smoked bath, ice bath, Moroccan hammam, sauna, steam, herbal soak. Eight ways to cleanse, detoxify and restore.', cta: 'Explore Bath Therapies' },
  { title: 'Massage & Body Therapies', subtitle: 'From KES 3,500', tag: 'Therapeutic Healing', ritualId: 'ubuntu-signature-therapy', accent: 'rgba(180,120,40,0.18)', image: '/images/Ubuntu-Signature-Therapy.jpeg', description: 'Ubuntu Signature Therapy, aromatherapy, deep tissue, lymphatic drainage, Swedish, shiatsu, bamboo stick, wood therapy and reflexology.', cta: 'Explore Massages' },
  { title: 'Body Care Treatments', subtitle: 'From KES 3,000', tag: 'Skin Renewal', ritualId: 'body-exfoliation', accent: 'rgba(160,120,60,0.16)', image: '/images/Body-Care-Treatments.jpeg', description: 'Full body mask and exfoliation treatments using natural botanicals. Polish, nourish and protect your skin with African earth ingredients.', cta: 'Explore Body Care' },
  { title: 'Facial & Hair Wellness', subtitle: 'From KES 3,500', tag: 'Natural Beauty', ritualId: 'hydrating-facial', accent: 'rgba(200,180,80,0.14)', image: '/images/Facial&Hair-Wellness.jpeg', description: 'Hydrating facial, skin renewal facial, herbal facial and hair masking treatment. Healthy beauty through natural, farm-sourced care.', cta: 'Book a Facial' },
  { title: 'Signature Packages', subtitle: 'From KES 9,000', tag: 'Curated Journey', ritualId: 'arohamai-signature-healing', accent: 'rgba(212,175,55,0.18)', image: '/images/Arohamai-Signature-Healing-Package.jpeg', description: 'Seven curated wellness journeys — detox, stress relief, full healing, muscle recovery, glow, prenatal care and lymphatic slimming.', cta: 'View All Packages' },
  { title: 'Couples Sanctuary', subtitle: 'From KES 10,000', tag: 'Couples', ritualId: 'stress-relief-package', accent: 'rgba(40,140,60,0.16)', image: '/images/Couples-Sanctuary.jpeg', description: 'Side-by-side rituals for two. Customise your shared healing journey with matching therapies, herbal soaks and private sanctuary time.', cta: 'Book for Two' },
  { title: 'Half Day Retreat', subtitle: 'KES 18,000', tag: 'Day Experience', ritualId: 'half-day-retreat', accent: 'rgba(180,140,200,0.16)', image: '/images/Jacuzzi.jpeg', description: 'Herbal tea welcome, bath therapy, signature massage, facial and a healthy wellness meal. Four hours of complete restoration.', cta: 'Reserve Your Retreat' },
  { title: 'Full Day Escape', subtitle: 'KES 30,000', tag: 'Full Sanctuary', ritualId: 'full-day-escape', accent: 'rgba(212,175,55,0.20)', image: '/images/Full-Day-Arohamai-Wellness-Escape.jpeg', description: 'Complete day access — personalized therapy, body treatment, facial, lunch and full relaxation lounge. The complete Arohamai experience.', cta: 'Book Full Day' },
]

// ─── THERMAL SANCTUARIES ─────────────────────────────────────────────────────

export const THERMALS: ThermalItem[] = [
  { name: 'Moroccan Bath', spec: 'KES 4,500 · 75 MIN', ritualId: 'moroccan-bath', description: 'Black soap, kessa exfoliation, argan oil seal and rose water on warm marble.', image: '/images/Moroccan-Bath.jpeg', glow: 'rgba(160,80,160,0.14)' },
  { name: 'Mud Bath', spec: 'KES 3,500 · 45 MIN', ritualId: 'mud-bath', description: 'Mineral-rich volcanic clay from the Great Rift Valley. Purifies pores, relieves deep muscle tension, renews from the outside in.', image: '/images/Mud-Bath.jpeg', glow: 'rgba(120,80,40,0.16)' },
  { name: 'Sauna & Steam', spec: 'From KES 2,000', ritualId: 'sauna-session', description: 'Traditional Finnish dry sauna and herbal steam sessions for cardiovascular reset, deep pore cleansing and cellular detox.', image: '/images/Sauna-Session.jpeg', glow: 'rgba(220,100,40,0.16)' },
  { name: 'Herbal Soak', spec: 'KES 3,000 · 50 MIN', ritualId: 'herbal-soak', description: 'Deeply restorative soak in locally sourced herb-infused warm water. Eases tension, nourishes the skin and calms the mind.', image: '/images/Herbal-Soak.jpeg', glow: 'rgba(100,160,80,0.14)' },
]
...
export const THERAPISTS: Therapist[] = [
  {
    id: 'adline', name: 'Adline Mkandoe', energy: 'Grounding', frequency: '432 Hz — Earth Frequency',
    experience: '7 Years', philosophy: 'Healing begins when the nervous system remembers stillness.',
    ...
    image: '/images/Adline-Mkandoe.jpeg',
  },
  {
    id: 'blessed', name: 'Blessed Kinuthia', energy: 'Deep Recovery', frequency: '528 Hz — Repair Frequency',
    experience: '2 Years', philosophy: 'Recovery is not luxury. It is survival for the modern mind.',
    ...
    image: '/images/Blessed-Kinuthia.jpeg',
  },
]
