...
// ── BentoGrid ─────────────────────────────────────────────────────────────────
// Ubuntu Kreative Village · Luxury Ecological Intelligence System
// 6 Master Log cards + Living Status Bar + Moxie Intelligence Core
// All original structure preserved. Every upgrade applied.
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// ENVIRONMENTAL DATA — makes the grid feel alive
// ─────────────────────────────────────────────────────────────────────────────
const ENV_SIGNALS = [
...
// ─────────────────────────────────────────────────────────────────────────────
// CARD DATA — emotionally renamed, full details
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// ANIMATED COUNTER — smooth eased roll-up
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// CORNER MARKS — UKV aesthetic brackets
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// LIVING STATUS BAR — scrolling environmental telemetry
// ─────────────────────────────────────────────────────────────────────────────
function LivingStatusBar() {
  const items = [...ENV_SIGNALS, ...ENV_SIGNALS] // doubled for seamless loop
...
// ─────────────────────────────────────────────────────────────────────────────
// BENTO CARD — single card with full cinematic treatment
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div
      ...
      style={{
        ...
        // Grain texture overlay (via pseudo — done via the inner span below)
    ...
    >
      ...
      <div style={{
        ...
        background: `radial-gradient(ellipse 70% 55% at 20% 20%, ${card.accent}18, transparent 65%)`,
        opacity: hovered ? 1 : 0,
      ...
      <div style={{
        position: 'absolute', inset: 0, pointerEvents: 'none',
        background: `radial-gradient(ellipse 50% 40% at 85% 90%, ${card.accent}0d, transparent 60%)`,
      ...
      <div style={{
        ...
        color: hovered ? card.accent : 'rgba(255,255,255,0.2)',
      ...
      <div style={{ padding: '22px 24px 24px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <h3 style={{
          ...
          color: hovered ? 'var(--cream)' : 'rgba(237,230,211,0.9)',
          marginBottom: 6,
        ...
        <p style={{
          ...
          lineHeight: 1.65, color: 'rgba(255,255,255,0.35)',
          marginBottom: 20,
        }}>
          {card.subtitle}
        </p>
          ...
          <div style={{ borderTop: '0.5px solid rgba(255,255,255,0.06)', paddingTop: 14 }}>
            ...
            <Link
              ...
              style={{
                ...
                fontFamily: 'var(--font-body)', fontSize: '8px',
                letterSpacing: '0.2em', textTransform: 'uppercase',
                color: card.accent, marginTop: 14,
...
// ─────────────────────────────────────────────────────────────────────────────
// MOXIE INTELLIGENCE CORE — full-width banner, upgraded
// ─────────────────────────────────────────────────────────────────────────────
function MoxieIntelligenceCore() {
  ...
  useEffect(() => {
    const t = setInterval(() => setWavePhase(p => p + 1), 140)
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 6 }}>
            <span style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.9rem,4vw,2.8rem)', fontWeight: 300, color: 'var(--cream)' }}>
              Meet
            </span>
            <span style={{
              ...
              textShadow: hovered ? '0 0 30px rgba(0,255,65,0.5)' : '0 0 12px rgba(0,255,65,0.2)',
          ...
          <div style={{ display: 'flex', gap: 18, marginTop: 12, flexWrap: 'wrap' }}>
            {[
              ...
              <div key={t.label} style={{ display: 'flex', flex: 'column', gap: 2 }}>
                <span style={{ fontFamily: 'var(--font-body)', fontSize: '7px', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.2)', display: 'block' }}>
                  {t.label}
                </span>
        ...
        <div style={{
          ...
          {Array.from({ length: BAR_COUNT }).map((_, i) => (
            <div key={i} style={{
              width: 3,
              height: `${getBarHeight(i) * 52}px`,
              background: `rgba(0,255,65,${0.3 + getBarHeight(i) * 0.5})`,
              transition: 'height 0.14s ease, background 0.14s ease',
              flexShrink: 0,
            }} />
          ))}
        </div>
        ...
        <Link
          ...
          style={{
            ...
            background: hovered ? 'rgba(0,255,65,0.08)' : 'transparent',
          ...
          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(0,255,65,0.12)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(0,255,65,0.6)' }}
          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = hovered ? 'rgba(0,255,65,0.08)' : 'transparent'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(0,255,65,0.4)' }}
        >
          Chat with Moxie →
        </Link>
      </div>
...
export default function BentoGrid({ eventsLabel = 'Events Ledger' }: BentoGridProps) {
  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', padding: '80px 0 96px' }}>
        ...
        <div style={{ maxWidth: '88rem', margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{
            ...
            {/* Row 1: Farm (5 cols) + Restaurant (7 cols) */}
            ...
            {/* Row 2: Cottages + Spa + Events (4 cols each) */}
            ...
            {/* Row 3: Moxie Intelligence Core (full width) */}
